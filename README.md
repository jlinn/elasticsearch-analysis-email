...
## Installation
```bash
bin/plugin --install analysis-email --url https://github.com/jlinn/elasticsearch-analysis-email/releases/download/v1.0.0/elasticsearch-analysis-email-1.0.0.zip
```
