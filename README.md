...
## Installation
```bash
bin/plugin install analysis-email --url https://github.com/jlinn/elasticsearch-analysis-email/releases/download/v2.0.0/elasticsearch-analysis-email-2.0.0.zip
```
